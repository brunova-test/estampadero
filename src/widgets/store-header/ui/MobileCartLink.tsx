...
export function MobileCartLink() {
  ...
  return (
    <Link
      ...
      title="Carrito"
      className="hover:text-mint focus-visible:text-mint relative grid h-11 w-11 place-items-center text-white transition-colors md:hidden"
    >
      <svg
        aria-hidden="true"
        viewBox="0 0 24 24"
      ...
      {quantity > 0 ? (
        <span className="bg-deep border-ink absolute top-0 right-0 grid min-h-5 min-w-5 place-items-center rounded-full border-2 px-1 text-[10px] leading-none font-black text-white">
